...
.config(function($stateProvider, $urlRouterProvider) {
  ...
  .state('app.category_feed', {
    ...
    resolve: {
      ...
      feed: function(FeedService, $stateParams){
        // Default page is 1
        var page = 1;
        return FeedService.getFeedByCategory(page, $stateParams.catid, $stateParams.subid);
      },
      category: function(CategoryService, $stateParams){
        return CategoryService.getCategory($stateParams.categoryId, $stateParams.subcategoryId);
      }
    }
  })
  ...
  .state('app.browse', {
    ...
    resolve: {
      ...
      subcategorias: function(Categorias, $stateParams){
        return Categorias.getSubcategorias($stateParams.catid);
      }
    }
  })
